...
class CustomTextField extends StatelessWidget {
  ...
  const CustomTextField({Key? key,this.isObscure=false, this.suffixIcon , required this.textEditingController, required this.focusNode, this.prefixIcon,this.elevation, this.borderRadius, this.hintText, this.inputAction, this.inputType, this.onInputText, this.borderColor}) : super(key: key);
